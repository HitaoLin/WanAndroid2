 ...
 * </pre>
 */
public class RvWechartArticleAdapter extends RecyclerView.Adapter<RvWechartArticleAdapter.ViewHolder> {
    ...
    public RvWechartArticleAdapter(List<WechartArticleDatasBean> wechartArticleDatasBeanList) {
    ...
    public RvWechartArticleAdapter.OnItemClickListener mOnItemClickListener;//第二步：声明自定义的接口

    //第三步：定义方法并暴露给外面的调用者
    public void setOnItemClickListener(RvWechartArticleAdapter.OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        ...
        WechartArticleDatasBean articleDatasBean = wechartArticleDatasBeanList.get(pos);
